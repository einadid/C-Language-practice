...
// The string will contain small and capital English alphabets and digits only. 
// You need to tell how many of them are capital alphabets, 
...
// then the count of small alphabets then the count of digits. 
